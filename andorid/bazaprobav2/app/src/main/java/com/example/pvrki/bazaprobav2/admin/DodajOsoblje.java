...
public class DodajOsoblje extends AppCompatActivity {
    Intent i;
    String username;
    String password;
    Statement stmt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dodaj_osoblje2);
        i=getIntent();
    ...
    public void ClickDodajOsoblje(View view) throws SQLException {
        Intent i2;
        ...
        try {
            ...
            if (lozinka.length() < 8 || isUpperCase==false) {
                ...
                inputPassLayout.setError("Lozinka treba biti kombinacija od minimalno 8 znakova (Velika slova,mala slova,brojevi)");
            }else{
                inputPassLayout.setError (null);
                inputPassLayout.setErrorEnabled (false);
            }
            ...
            new Thread (new Runnable () {
                public void run() {
                    ...
                    try {
                        ...
                        String addUser= "ALTER ROLE [osoblje] ADD MEMBER "+korisnickoIme;
        ...
        if(errorCheck==null)
        {
            runOnUiThread(new Runnable () {
                public void run() {
                    Toast.makeText (DodajOsoblje.this , "Osoblje uspješno dodano" , Toast.LENGTH_SHORT).show ();
                }});
            try {
                sleep(2500);
